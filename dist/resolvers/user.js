...
let UserResolver = class UserResolver {
    ...
    async forgotPassword(email, { redis }) {
        ...
        (0, sendEmail_1.sendEmail)(email, `<a href="http://localhost:3000/change-password/${token}">resert password</a>`);
        return true;
    }
    me({ req }) {
    ...
    async login(usernameOrEmail, password, { req }) {
        const user = await User_1.User.findOneBy(constants_1.EMAIL_FORMAT.test(usernameOrEmail)
